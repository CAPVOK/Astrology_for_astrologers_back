...
func (r *Repository) GetConstellationsUser(searchName, startFormationDate, endFormationDate, constellationStatus string, userID uint) ([]model.ConstellationRequest, error) {
...
func (r *Repository) UpdateConstellationStatusUser(constellationID, userID uint) error {
	...
	constellation.FormationDate = &currentTime
